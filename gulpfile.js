...
gulp.task('favicon-dev', function () {
    const FAVICON_DATA_FILE = paths(gPaths.dev).favicon.dest + '/faviconData.json';
...
gulp.task('sprite-dev', function () {
    const spriteData = gulp.src(paths(gPaths.dev).sprite.src).pipe(plugins.spritesmith({
        imgName: 'sprite.png',
        cssName: 'sprite.scss',
...
gulp.task('favicon-prod', function () {
    const FAVICON_DATA_FILE = paths(gPaths.prod).favicon.dest + '/faviconData.json';
...
gulp.task('sprite-prod', function () {
    const spriteData = gulp.src(paths(gPaths.prod).sprite.src).pipe(plugins.spritesmith({
        imgName: 'sprite.png',
        cssName: 'sprite.scss',
        imgPath: '../img/sprite.png'
    }));
